...
else document.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"/sites/all/themes/colweb/css/lscreen.css\" media=\"screen\" title=\"CoL (large)\" />");
//-->
</script>
...
// HELP		        echo "</p>";
	...
	?>
        ...
        if (!empty($content_dynamic)){
	        echo "<div id=\"dynamic\">\n";
//	        echo "<a href=\"http://www.catalogueoflife.org/dynamic-checklist/\"><img src=\"/images/head_right2.jpg\"><h2>Updated Edition</h2></a>";
		...
		echo "</div> <!-- /content-content_dynamic -->\n";
        }
	?>
        <?php
	...
	?>
		...
		echo "</div> <!-- /content-content_archive -->\n";
	}
	?>
