  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php
		if ($title){
			$title2=ucwords($title);
			echo "<h1 class=\"title\">$title2</h1>\n";
		}
        ?>
        <?php print $messages; ?>
        <?php if ($tabs): ?>
        ...
        <?php
//	if ($feed_icons){
//		echo "<div class=\"feed-icons\">$feed_icons</div>";
//	}
	?>
	...
	<?php
//	echo "<div class=\"region-sidebar-col\"><div class=\"section\">\n<div id=\"block-block-4\"><p>MORE HERE?</p></div>\n";
	?>
