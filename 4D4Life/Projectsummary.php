<?php $pagenum="Projectsummary"; require_once "./LightNEasy/runtime.php"; ?>
...
<tr ><td colspan = 2 id="mainlevel-box"><span ><ul id="mainlevel-nav"><li class="textblue">Catalogue of Life services:&nbsp;<a href="http://www.catalogueoflife.org/annual-checklist" class="mainlevel-nav" target = "_new">Annual Checklist</a></li><li><a href="http://www.catalogueoflife.org/dynamic-checklist" class="mainlevel-nav" target = "_new">Dynamic Checklist</a></li></ul></span></td></tr>
<tr><td class="sd_menu">
<h2>Summary</h2><ul><?php print fullmenu(1); ?>
</ul><br /><br /><?php print extra(); ?>
<br />
</td><td class="sd_content"><?php content("Projectsummary"); ?></td></tr>
</table>
